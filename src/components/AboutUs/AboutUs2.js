          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-5">
                ...
                <h2 className="mt-4">
                  Deliver your product using AppCo
                </h2>
                <p className="mb-4 lh-190">
                  Quick has all the right tools in order to
                  make your website building process a
                  breeze and automatize your time-consuming
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="py-2">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <p className="mb-0">
                          Globally orchestrate tactical
                          channels whereas bricks
                        </p>
                      </div>
                    </div>
                  </li>
